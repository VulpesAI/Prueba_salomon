...
exports.CreateAuthTokens202412161200 = void 0;
class CreateAuthTokens202412161200 {
    constructor() {
        this.name = 'CreateAuthTokens202412161200';
    }
    ...
    `);
        ...
        await queryRunner.query('CREATE INDEX IF NOT EXISTS "IDX_auth_tokens_user_refresh" ON "auth_tokens" ("user_id", "refresh_token_hash")');
        await queryRunner.query('ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "uid" character varying');
        await queryRunner.query('ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "password_hash" character varying');
        await queryRunner.query('ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "metadata" json');
        await queryRunner.query("ALTER TABLE \"users\" ADD COLUMN IF NOT EXISTS \"roles\" text NOT NULL DEFAULT 'user'");
        await queryRunner.query('ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "preferences" json');
        await queryRunner.query('ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "oauth_providers" json');
        ...
        await queryRunner.query('ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "mfa_temp_secret" character varying');
        await queryRunner.query('ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "mfa_backup_codes" json');
        await queryRunner.query('ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "last_mfa_at" timestamptz');
        await queryRunner.query('ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "profile" json');
        await queryRunner.query(`
      DO $$
      BEGIN
        IF NOT EXISTS (
...
exports.CreateAuthTokens202412161200 = CreateAuthTokens202412161200;
//# sourceMappingURL=202412161200-CreateAuthTokens.js.map