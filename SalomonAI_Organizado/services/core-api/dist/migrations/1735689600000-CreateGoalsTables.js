...
exports.CreateGoalsTables1735689600000 = void 0;
class CreateGoalsTables1735689600000 {
    constructor() {
        this.name = 'CreateGoalsTables1735689600000';
    }
    ...
    `);
        await queryRunner.query('CREATE INDEX IF NOT EXISTS "IDX_goal_progress_goal_date" ON "goal_progress" ("goal_id", "recorded_at")');
        await queryRunner.query('CREATE INDEX IF NOT EXISTS "IDX_financial_goals_user_status" ON "financial_goals" ("user_id", "status")');
    }
...
exports.CreateGoalsTables1735689600000 = CreateGoalsTables1735689600000;
//# sourceMappingURL=1735689600000-CreateGoalsTables.js.map