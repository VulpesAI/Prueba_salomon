    ...
    try {
      ...
      const description =
        error instanceof ApiError && error.status === 404
          ? 'Nuestro canal automático aún no está disponible. Escríbenos directamente a soporte@salomonai.cl.'
    ...
    <section className="py-20 bg-secondary/20" id="contact">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl font-bold mb-6 text-foreground">¿Listo para revolucionar tus finanzas?</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <Card className="bg-gradient-card border-primary/20">
            <CardHeader>
              ...
              <p className="text-sm text-muted-foreground">Responderemos en menos de 24 horas</p>
            </CardHeader>
            <CardContent>
          ...
          <div className="space-y-8">
            ...
            <Card className="bg-gradient-card border-primary/20">
              ...
              <CardContent className="space-y-4">
                <p className="text-sm text-muted-foreground">Reserva 30 minutos para ver SalomónAI en acción</p>
                ...
                <Button className="w-full bg-accent hover:bg-accent/90" type="button">
