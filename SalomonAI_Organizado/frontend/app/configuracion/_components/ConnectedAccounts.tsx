...
export default function ConnectedAccounts() {
  ...
  return (
    <div className="space-y-3 rounded-card border border-soft bg-gradient-card p-4">
      <h3 className="text-base font-semibold text-primary">Cuentas conectadas</h3>
      {isLoading ? (
      ...
      <ul className="space-y-2">
        {accounts.map((account) => (
          <li
            key={account.id}
            className="flex items-center justify-between rounded-lg border border-soft bg-[rgba(8,17,52,0.06)] p-2 transition-colors hover:bg-[rgba(8,17,52,0.12)] dark:bg-[rgba(255,255,255,0.04)] dark:hover:bg-[rgba(255,255,255,0.08)]"
          >
            ...
            <button
              className="h-8 cursor-not-allowed rounded-md border border-soft bg-[rgba(8,17,52,0.06)] px-3 text-sm text-primary opacity-60 dark:bg-[rgba(255,255,255,0.06)]"
              disabled
              type="button"
            >
              Gestionar
