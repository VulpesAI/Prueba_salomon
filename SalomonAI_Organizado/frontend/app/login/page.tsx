...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({ title: '¡Bienvenido de nuevo!', description: 'Autenticación exitosa.' });
        ...
        <div className="max-w-md w-full">
          ...
          <Card className="p-6 bg-gradient-card border-primary/20">
            ...
            <Button
              ...
              onClick={() => toast({ title: 'Integración en desarrollo', description: 'Muy pronto podrás iniciar sesión con Google.' })}
            >
